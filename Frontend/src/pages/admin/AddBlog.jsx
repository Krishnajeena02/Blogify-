...
<div className='max-w-lg h-74 pb-16 sm:pb-10 pt-2 relative  '>
    ...
    <button disabled={loading} className='absolute bottom-1 right-2 ml-2 text-sm  bg-black/15
    px-4 py-1.5 rounded hover:underline hover:bg-black/80 transition-all cursor-pointer' type='button'      onClick={genrateWithAI}><span className=" bg-clip-text text-transparent bg-linear-to-r from-pink-500 via-blue-600 to-purple-500">Generate with AI</span></button>
